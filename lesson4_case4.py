...
def multiplication_chain(num):
    """
    Принимает положительное число num и возвращает количество раз count_multy,
    которое вы должны перемножить цифры числа num и полученных произведений,
    пока не получите одну цифру.
