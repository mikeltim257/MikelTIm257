...
def move_zeros(lst):
    """
    Алгоритм, который берет список lst и перемещает все нули в конец, сохраняя порядок остальных элементов.
    :param lst: Список с нулями в конце
    :return: (lst1) Список без нулей
    :return: (ls2) Список нулей
    :return: (n) Элемент списка
    """
    lst1 = []
    lst2 = []
    for n in lst:
